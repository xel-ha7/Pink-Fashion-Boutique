	...
	<div class="jsn-easyslider-plg-editor-wrapper">
		...
		<div class="insert">
			<div class="form-actions">
				<button disabled="disabled" id="btn_insert_button" onclick="window.parent.jsnSelectSlider(jQuery('#slider_id'), '<?php echo $objUtils->randSTR(8);?>')" name="button_installation_data" type="button" class="btn">
