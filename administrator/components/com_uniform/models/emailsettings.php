...
class JSNUniformModelEmailSettings extends JModelAdmin
{
	...
	public function getItem($pk = null)
	{
		...
		//$item = (object) array('template_id' => '', 'form_id' => '', 'confirm_sending_email' => '', 'template_notify_to' => '', 'template_from' => '', 'template_from_name' => '', 'template_to' => '', 'template_subject' => '', 'template_message' => '', 'template_attach' => '');
		...
		elseif (!empty($control) && $control == "form")
		{
			if (!empty($form_id))
			{
				...
				if ($emailTemplate)
				{
					...
					//$item->confirm_sending_email = $emailTemplate->confirm_sending_email;
			...
			else
			{
				...
				//$item->confirm_sending_email = isset($emailTemplate->confirm_sending_email) ? $emailTemplate->confirm_sending_email : '';
	...
	public function saveForm($data)
	{
		...
		{
			$data['template_subject'] = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) )?stripslashes($data['template_subject']):$data['template_subject'];
		}
		if (isset($data['template_message']))
		{
			$data['template_message'] = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) )?stripslashes($data['template_message']):$data['template_message'];
		}
		if (isset($data['template_from']))
		{
			$data['template_from'] = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) )?stripslashes($data['template_from']):$data['template_from'];
		}
		if (isset($data['template_reply_to']))
		{
			$data['template_reply_to'] = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) )?stripslashes($data['template_reply_to']):$data['template_reply_to'];
		}
		...
		//$data['confirm_sending_email'] = empty($data['confirm_sending_email']) ? 0 : (int) $data['confirm_sending_email'];
	...
	public function saveConfig($data)
	{
		...
		{
			$data['jform']['template_message'] = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) )?stripslashes($data['jform']['template_message']):$data['jform']['template_message'];
		}
		if (isset($data['jform']['template_subject']))
		{
			$data['jform']['template_subject'] = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) )?stripslashes($data['jform']['template_subject']):$data['jform']['template_subject'];
		}
		if (isset($data['jform']['template_from']))
		{
			$data['jform']['template_from'] = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) )?stripslashes($data['jform']['template_from']):$data['jform']['template_from'];
		}
		if (isset($data['jform']['template_reply_to']))
		{
			$data['jform']['template_reply_to'] = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) )?stripslashes($data['jform']['template_reply_to']):$data['jform']['template_reply_to'];
		}
