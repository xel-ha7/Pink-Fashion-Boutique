...
class JSNUniformViewSubmissions extends JSNBaseView
{
	...
	protected function addAssets()
	{
		...
		JSNHtmlAsset::addStyle('http' . (JSNUniformHelper::isHttps() ? 's' : '') . '://fonts.googleapis.com/css?family=Chau+Philomene+One');
	}
	...
	public function getViewField()
	{
		...
		$listViewField = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes($listViewField) : $listViewField;
