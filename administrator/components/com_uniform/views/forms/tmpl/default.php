...
<div class="jsn-page-list">
    <div class="jsn-bootstrap">
        <form action="<?php echo JRoute::_('index.php?option=com_uniform&view=forms'); ?>" method="post" class="form-inline" id="adminForm" name="adminForm">
			...
			$JSNItemList->addColumn('JSN_UNIFORM_FORM_LAST_SUBMITTED_AT', 'form_last_submitted', 'custom', array('class' => 'jsn-column-large', 'sortTable' => 'uf.form_last_submitted' , 'obj' => $this, 'method' => 'renderCustomDateLastSubmission'));
