...
// 		}
	...
	public function savePage()
	{
		...
		{
			$formPageName = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes($postData['form_page_name']) : $postData['form_page_name'];
		...
		if (!empty($postData['form_page_name']))
		{
			...
			if (isset($postData['form_content']))
			{
				...
				$formContent = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes($formContent) : $formContent;
			}
			$formPageName = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes($postData['form_page_name']) : $postData['form_page_name'];
		...
		if (!empty($postData['form_list_page']))
		{
			...
			{
				$dataField = "";
				$pageName = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes($listPage[0]) : $listPage[0];
			...
			$formListPage = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes(json_encode($postData['form_list_page'])) : json_encode($postData['form_list_page']);
	...
	public function loadPage()
	{
		...
		if (!empty($post['form_page_name']))
		{
			...
			$formPageName = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes($post['form_page_name']) : $post['form_page_name'];
			...
			if (isset($post['form_page_old_name']) && $post['form_page_old_name'] != $formPageName)
			{
				...
				if (!empty($post['form_page_old_content']))
				{
					...
					$formOldContent = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes($formContentOld) : $formContentOld;
				...
				if (!empty($post['form_page_old_container']))
				{
					...
					$formContainerOld = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes($formContainerOld) : $formContainerOld;
		...
		$containerPage = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes($containerPage) : $containerPage;
		if (!empty($post['join_page']) && $post['join_page'] == "join" && isset($post['form_list_page']) && count($post['form_list_page']) > 1)
		{
			...
			foreach ($post['form_list_page'] as $index => $listPage)
			{
				...
				if (!empty($pageName) && !empty($post['form_page_name']))
				{
					...
					$pageContainer = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes($pageContainer) : $pageContainer;
				...
				if ($index == 0)
				{
					...
					$pageName1 = ( ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc() == true) || ( version_compare(phpversion(), '7.4.0', '<') && function_exists('get_magic_quotes_runtime') && get_magic_quotes_runtime() == true) ) ? stripslashes($listPage[1]) : $listPage[1];
