...
class JSNUtilsText
{
	...
	public static function getConstant($name, $component = '')
	{
		...
		if ( ! defined($const) )
		{
			if ( is_file(JPATH_ADMINISTRATOR . "/components/com_{$component}/{$component}.defines.php") )
			{
				include_once(JPATH_ADMINISTRATOR . "/components/com_{$component}/{$component}.defines.php");
			}
			elseif ( is_file(JPATH_ADMINISTRATOR . "/components/com_{$component}/defines.{$component}.php") )
			{
