...
class JSNUniformController extends JSNBaseController
{
	...
	public function generateStylePages()
	{
		...
		if (!empty($formId))
		{
			...
			$prefix = JSNUniformHelper::getBootstrapPrefix();
			$prefix = str_replace("jsn-",".jsn-",$prefix);
			$prefix = str_replace(" ","",$prefix);			
			echo JSNUniformHelper::generateStylePages($formStyleCustom,
				"#jsn_form_{$formId}.jsn-master {$prefix} .jsn-form-content .control-group",
				"#jsn_form_{$formId}.jsn-master {$prefix} .jsn-form-content .control-group.ui-state-highlight",
				"#jsn_form_{$formId}.jsn-master {$prefix} .jsn-form-content .control-group .control-label",
				"#jsn_form_{$formId}.jsn-master {$prefix} .jsn-form-content .control-group.error .help-block,\n" .
				"#jsn_form_{$formId}.jsn-master {$prefix} .jsn-form-content .control-group.error .help-inline,\n" .
				"#jsn_form_{$formId}.jsn-master {$prefix} .jsn-form-content .control-group.error .help-block span.label",
				"#jsn_form_{$formId}.jsn-master {$prefix} .jsn-form-content .control-group .label-important,\n" .
				"#jsn_form_{$formId}.jsn-master {$prefix} .jsn-form-content .control-group .label-important .badge-important",
				"#jsn_form_{$formId}.jsn-master {$prefix} .jsn-form-content .control-group .controls input,\n" .
				"#jsn_form_{$formId}.jsn-master {$prefix} .jsn-form-content .control-group .controls select,\n" .
				"#jsn_form_{$formId}.jsn-master {$prefix} .jsn-form-content .control-group .controls textarea"
			);
			echo "\n{$customCss}\n";
		}
		exit();
