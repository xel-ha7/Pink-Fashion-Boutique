...
class JSNUniformViewSubmission extends JSNBaseView
{
	...
	public function display($tpl = null)
	{
		...
		if (JSNUniformHelper::checkStateForm($this->_item->form_id))
		{
            ...
            $checkOwner = false;
			if (!empty($this->_params->submission_data_for_owner))
			{
			    $submissionDataForOwner = (bool) $this->_params->submission_data_for_owner;
			...
			else
			{
			    ...
			    $this->nextAndPreviousForm = $this->get('NextAndPreviousOwnerForm');
